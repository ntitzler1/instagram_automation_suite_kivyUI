...
"""
Next thing to add: if a user has already been processed, skip it
"""
...
def writeOut(client, fileName, userList):
    ...
    f = open("../csvFiles/clientFiles/"+clientName +"/"+ "directory.txt","r")
    lines = f.readlines()
    f.close()


    with open("../csvFiles/clientFiles/"+clientName +"/"+ "directory.txt", "w") as f:
...
def main():
        ...
        login = driver.find_element_by_xpath("/html/body/div[1]/div/div[1]/div[1]/div/div/div/div/div/div/div[2]/form/fieldset/div[1]/div[2]/input")
        login.send_keys("ntitzler@gmail.com")

        password = driver.find_element_by_xpath("/html/body/div[1]/div/div[1]/div[1]/div/div/div/div/div/div/div[2]/form/fieldset/div[2]/div[2]/input")
        password.send_keys("77Kidner!!!")

        button = driver.find_element_by_xpath("/html/body/div[1]/div/div[1]/div[1]/div/div/div/div/div/div/div[2]/form/fieldset/div[3]/button")
        button.click()
        time.sleep(10)
        driver.quit()
        #print(sys.argv)
